...
func TestValidatePatchItemUsesRegistry(t *testing.T) {
	cases := []struct {
		...
		{name: "embedding dimensions policy send", item: PatchItem{Namespace: "file", Key: "embedding_dimensions_policy", Value: "send"}},
		{name: "embedding dimensions policy omit", item: PatchItem{Namespace: "file", Key: "embedding_dimensions_policy", Value: "omit"}},
		{name: "embedding dimensions policy invalid", item: PatchItem{Namespace: "file", Key: "embedding_dimensions_policy", Value: "auto"}, wantCode: settingCodeInvalidValue, wantRule: "enum"},
